...
/** Connect all bitcoinII-d signal handlers */
void noui_connect();

/** Redirect all bitcoinII-d signal handlers to LogInfo. Used to check or suppress output during test runs that produce expected errors */
