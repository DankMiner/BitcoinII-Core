    ...
    return RPCHelpMan{"getmempoolinfo",
        ...
        RPCResult{
            RPCResult::Type::OBJ, "", "",
            {
                ...
                {RPCResult::Type::BOOL, "permitbaremultisig", "Whether BitcoinII mempool rules permit bare multisig outputs (always false)"},
                {RPCResult::Type::NUM, "maxdatacarriersize", "BitcoinII maximum complete OP_RETURN scriptPubKey size in bytes"},
                {RPCResult::Type::STR, "maxtapscriptsize", "BitcoinII maximum accepted tapscript size in bytes"},
                ...
                {RPCResult::Type::NUM, "policyrejections", "Number of transactions rejected by BitcoinII policy since startup"},
