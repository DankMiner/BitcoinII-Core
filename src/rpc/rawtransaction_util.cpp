...
void SignTransaction(CMutableTransaction& mtx, const SigningProvider* keystore, const std::map<COutPoint, Coin>& coins, const UniValue& hashType, UniValue& result, uint32_t sighash_fork_id)
{
    ...
    bool complete = SignTransaction(mtx, keystore, coins, *nHashType, input_errors, sighash_fork_id);
