...
FUZZ_TARGET(coin_grinder_is_optimal)
{
    ...
    // Set effective feerate up to MAX_MONEY sat2s per 1'000'000 vB (2'100'000'000 sat2/vB = 21'000 BC2/kvB).
    ...
    LIMITED_WHILE(fuzzed_data_provider.ConsumeBool(), max_output_groups)
    {
        ...
        // Ensure that each UTXO has at least an effective value of 1 sat2
...
FUZZ_TARGET(bnb_finds_min_waste)
{
    ...
    CoinSelectionParams coin_params{fast_random_context};
    coin_params.m_subtract_fee_outputs = false;
    // Set effective feerate up to 10'000'000 sat2s per kvB (10'000 sat2/vB).
