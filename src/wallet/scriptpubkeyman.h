...
public:
    ...
    //! Signature-hash replay-protection domain for transactions intended for the next block.
    //! Non-node/test wallet storage defaults to the legacy domain.
    virtual uint32_t GetSighashForkId() const { return 0; }
