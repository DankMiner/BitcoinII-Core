...
#ifndef BITCOINII_PRIMITIVES_TRANSACTION_IDENTIFIER_H
#define BITCOINII_PRIMITIVES_TRANSACTION_IDENTIFIER_H
...
#endif // BITCOINII_PRIMITIVES_TRANSACTION_IDENTIFIER_H
