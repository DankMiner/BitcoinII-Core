...
struct Satisfier : public KeyConverter {
    ...
    miniscript::Availability Sat2Hash(const std::vector<unsigned char>& hash, std::vector<unsigned char>& preimage, ChallengeType chtype) const {
    ...
    miniscript::Availability Sat2SHA256(const std::vector<unsigned char>& hash, std::vector<unsigned char>& preimage) const { return Sat2Hash(hash, preimage, ChallengeType::SHA256); }
    miniscript::Availability Sat2RIPEMD160(const std::vector<unsigned char>& hash, std::vector<unsigned char>& preimage) const { return Sat2Hash(hash, preimage, ChallengeType::RIPEMD160); }
    miniscript::Availability Sat2HASH256(const std::vector<unsigned char>& hash, std::vector<unsigned char>& preimage) const { return Sat2Hash(hash, preimage, ChallengeType::HASH256); }
    miniscript::Availability Sat2HASH160(const std::vector<unsigned char>& hash, std::vector<unsigned char>& preimage) const { return Sat2Hash(hash, preimage, ChallengeType::HASH160); }
};
