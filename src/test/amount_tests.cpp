...
BOOST_AUTO_TEST_CASE(GetFeeTest)
{
    ...
    // due to only supporting satooshis per kB, so CFeeRate(CAmount(1), 1001) was equal to CFeeRate(0)
...
BOOST_AUTO_TEST_CASE(ToStringTest)
{
    ...
    BOOST_CHECK_EQUAL(feeRate.ToString(FeeRateFormat::BC2_KVB), "0.00000001 BC2/kvB");
    BOOST_CHECK_EQUAL(feeRate.ToString(FeeRateFormat::SAT2_VB), "0.001 sat2/vB");
}
