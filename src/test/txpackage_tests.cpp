...
// A fee amount that is above 1sat2/vB but below 5sat2/vB for most transactions created within these
// unit tests.
...
BOOST_AUTO_TEST_CASE(package_cpfp_tests)
{
    ...
    // The mempool minimum feerate is 5sat2/vB, but this package just pays 800 satooshis total.
...
BOOST_AUTO_TEST_CASE(package_rbf_tests)
{
    ...
    {
        // 1 parent paying 200sat2, 1 child paying 300sat2
        Package package1;
        // 1 parent paying 200sat2, 1 child paying 500sat2
        Package package2;
    ...
    // Test package rbf.
    {
        ...
        // 1 parent paying 200sat2, 1 child paying 200sat2.
        Package package1{tx_parent_1, tx_child_1};
        // 1 parent paying 800sat2, 1 child paying 200sat2.
        Package package2{tx_parent_2, tx_child_2};
        // 1 parent paying 199sat2, 1 child paying 1300sat2.
