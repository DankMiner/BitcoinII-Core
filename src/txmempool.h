 ...
 * BitcoinII-specific logic. Specifically, TxGraph handles (for each transaction)
 ...
 *
 * CTxMemPool itself handles the BitcoinII-specific parts of mempool
...
protected:
    ...
    /**
     * BitcoinII policy rejections recorded since this node process
...
public:
     ...
     * configured BitcoinII transaction policy.
     */
