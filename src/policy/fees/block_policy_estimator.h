...
#ifndef BITCOINII_POLICY_FEES_BLOCK_POLICY_ESTIMATOR_H
#define BITCOINII_POLICY_FEES_BLOCK_POLICY_ESTIMATOR_H
...
#endif // BITCOINII_POLICY_FEES_BLOCK_POLICY_ESTIMATOR_H
