...
std::string CFeeRate::ToString(FeeRateFormat fee_rate_format) const
{
    ...
    case FeeRateFormat::BC2_KVB: return strprintf("%d.%08d %s/kvB", feerate_per_kvb / COIN, feerate_per_kvb % COIN, CURRENCY_UNIT);
    case FeeRateFormat::SAT2_VB: return strprintf("%d.%03d %s/vB", feerate_per_kvb / 1000, feerate_per_kvb % 1000, CURRENCY_ATOM);
