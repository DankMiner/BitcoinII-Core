...
/** Upstream BitcoinII Core bare-multisig policy default. */
...
/**
 * Upstream BitcoinII Core OP_RETURN relay reference size in vbytes.
 */
 ...
 * for BitcoinII policy reporting and do not affect consensus.
 */
