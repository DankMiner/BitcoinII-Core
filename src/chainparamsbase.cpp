...
void SetupChainParamsBaseOptions(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-testcoinbasematurityheight=<n>", "Enable experimental work-based coinbase maturity for rewards created at or above this height; requires -testcoinbasematuritywork (regtest-only)", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY | ArgsManager::DISALLOW_NEGATION | ArgsManager::DISALLOW_ELISION, OptionsCategory::DEBUG_TEST);
    argsman.AddArg("-testcoinbasematuritywork=<64hex>", "Fixed nonzero post-creation chainwork target for experimental coinbase maturity; requires -testcoinbasematurityheight (regtest-only)", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY | ArgsManager::DISALLOW_NEGATION | ArgsManager::DISALLOW_ELISION, OptionsCategory::DEBUG_TEST);
