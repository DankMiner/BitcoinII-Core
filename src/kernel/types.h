...
//! that can be used internally by functions in the libbitcoinII_kernel library,
...
#ifndef BITCOINII_KERNEL_TYPES_H
#define BITCOINII_KERNEL_TYPES_H
...
#endif // BITCOINII_KERNEL_TYPES_H
