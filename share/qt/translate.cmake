...
function(extract_strings output)
  ...
  file(STRINGS "bitcoinIIstrings.po" text ENCODING "UTF-8")
...
static const char UNUSED *bitcoinII_strings[] = {
  ...
  set(prefix "QT_TRANSLATE_NOOP(\"bitcoinII-core\", \"")
  set(suffix "\"),\n")
...
set(subtrees crc32c crypto/ctaes minisketch secp256k1)
...
extract_strings("${PROJECT_SOURCE_DIR}/src/qt/bitcoinIIstrings.cpp"
...
execute_process(
  COMMAND ${LUPDATE_EXECUTABLE}
    ...
    ${PROJECT_SOURCE_DIR}/src/qt/bitcoinIIstrings.cpp
    -ts ${PROJECT_SOURCE_DIR}/src/qt/locale/bitcoinII_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)
...
execute_process(
  COMMAND ${LCONVERT_EXECUTABLE}
    -drop-translations
    -o ${PROJECT_SOURCE_DIR}/src/qt/locale/bitcoinII_en.xlf
    -i ${PROJECT_SOURCE_DIR}/src/qt/locale/bitcoinII_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)

file(READ "${PROJECT_SOURCE_DIR}/src/qt/locale/bitcoinII_en.xlf" bitcoinII_en)
string(REPLACE "source-language=\"en\" target-language=\"en\""
  "source-language=\"en\"" bitcoinII_en "${bitcoinII_en}"
)
string(REGEX REPLACE " *<target xml:space=\"preserve\"></target>\n"
  "" bitcoinII_en "${bitcoinII_en}"
)
file(WRITE "${PROJECT_SOURCE_DIR}/src/qt/locale/bitcoinII_en.xlf" "${bitcoinII_en}")
