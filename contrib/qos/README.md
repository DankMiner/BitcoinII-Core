...
This means one can have an always-on bitcoinII-d instance running, and another local bitcoinII-d/bitcoinII-qt instance which connects to this node and receives blocks from it.
