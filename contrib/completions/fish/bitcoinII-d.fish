...
complete --command bitcoinII-d --no-files

# Extract options
function __fish_bitcoinII-d_get_options
...
complete \
    --command bitcoinII-d \
    --arguments "(__fish_bitcoinII-d_get_options --nofiles)"
