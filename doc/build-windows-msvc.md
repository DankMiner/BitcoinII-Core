...
This guide describes how to build bitcoinII-d, command-line utilities, and GUI on Windows using Microsoft Visual Studio.
...
vcpkg installation during the configuration step might fail for various reasons unrelated to BitcoinII Core.
...
can occur if your local BitcoinII Core repository path contains spaces, you can override the vcpkg install directory
