...
BitcoinII Core version v30.1 is now available from:
...
- #33229 multiprocess: Don't require bitcoinII -m argument when IPC options are used
...
- #33723 chainparams: remove dnsseed.bitcoinII.dashjr-list-of-p2p-nodes.us
