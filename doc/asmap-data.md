...
but BitcoinII Core also embeds a default map in its builds to make the feature
...
matches with other users' results. Before the map is usable by BitcoinII Core
