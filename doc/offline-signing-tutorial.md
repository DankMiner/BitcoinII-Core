...
This workflow uses [Partially Signed BitcoinII Transactions](/doc/psbt.md) (PSBTs) to transfer the transaction to and from the offline wallet for signing using the private keys.
