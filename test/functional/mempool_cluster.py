...
class MempoolClusterTest(BitcoinIITestFramework):
    ...
    def test_cluster_limit_rbf(self, max_cluster_count):
        ...
        for _ in range(max_cluster_count - 1):
            ...
            fees_rbf_sat2s += int(child_tx["fee"] * COIN)
        ...
        tx_merger_replacer = self.wallet.create_self_transfer_multi(utxos_to_spend=utxos_created_by_parents, fee_per_output=fees_rbf_sat2s * 2)
