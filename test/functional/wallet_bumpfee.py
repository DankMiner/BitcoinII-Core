...
class BumpFeeTest(BitcoinIITestFramework):
    ...
    def run_test(self):
        ...
        # fund rbf node with 10 coins of 0.001 bc2 (100,000 satooshis)
    ...
    def test_invalid_parameters(self, rbf_node, peer_node, dest_address):
        ...
        for mode in ["foo", Decimal("3.1415"), "sat2/B", "BC2/kB"]:
...
def test_dust_to_fee(self, rbf_node, dest_address):
    ...
    # Bump with fee_rate of 350.25 sat2/vB vbytes to create dust.
