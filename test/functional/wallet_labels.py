...
class WalletLabelsTest(BitcoinIITestFramework):
    ...
    def test_label_named_parameter_handling(self):
        ...
        self.log.info("Test bitcoinII-cli -named passes parameter containing '=' by position if it does not specify a known parameter name and is in a string position")
