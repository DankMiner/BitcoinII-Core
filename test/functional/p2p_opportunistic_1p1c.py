...
class PackageRelayTest(BitcoinIITestFramework):
    ...
    def create_tx_below_mempoolminfee(self, wallet, utxo_to_spend=None):
        """Create a 1-input 0.1sat2/vB transaction using a confirmed UTXO. Decrement and use
    ...
    def test_other_parent_in_mempool(self):
        ...
        grandparent_high = self.wallet.create_self_transfer(fee_rate=FEERATE_1SAT2_VB*10, confirmed_only=True)
    ...
    def test_1p1c_on_1p1c(self):
        ...
        high_fee_grandparent = self.wallet.create_self_transfer(utxo_to_spend=low_fee_great_grandparent["new_utxo"], fee_rate=20*FEERATE_1SAT2_VB)
