...
class WalletGroupTest(BitcoinIITestFramework):
    def set_test_params(self):
        ...
        self.fee_rate = 20  # apply feerate of 20 sat2s/vB across all nodes
    ...
    def run_test(self):
        ...
        # Sending 1.4 bc2 should pick one 1.0 + one more. For node #1,
        ...
        # 1 sat2 higher, crossing the threshold from non-grouped to grouped.
