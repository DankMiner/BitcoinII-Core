...
EXTENDED_SCRIPTS = [
    ...
    'feature_coinbase_work_maturity.py',
]
...
BASE_SCRIPTS = [
    ...
    'interface_bitcoinII_cli.py',
    'feature_bind_extra.py',
    'mempool_resurrect.py',
    'wallet_txn_doublespend.py --mineblock',
    'tool_bitcoinII_chainstate.py',
    'tool_wallet.py',
    'tool_utils.py',
    ...
    'feature_bitcoinII_data_consensus.py',
    'feature_bitcoinII_taproot_consensus.py',
