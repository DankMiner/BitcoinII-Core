...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The bitcoinII-d node closes feeler connections as soon as a version
...
class P2PAddConnections(BitcoinIITestFramework):
    ...
    def run_test(self):
        ...
        # bitcoinII-d behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that bitcoinII-d sends its own version prior to processing
