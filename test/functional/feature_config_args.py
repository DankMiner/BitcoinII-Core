...
class ConfArgsTest(BitcoinIITestFramework):
    ...
    def test_negated_config(self):
        ...
        ignored_file_message = [f'Data directory "{self.nodes[0].datadir_path}" contains a "bitcoinII.conf" file which is explicitly ignored using -noconf.']
    ...
    def test_config_file_parser(self):
        ...
        with open(self.nodes[0].datadir_path / 'bitcoinII.conf', 'a') as conf:
