...
class P2PPrivateBroadcast(BitcoinIITestFramework):
    ...
    def run_test(self):
        ...
        # Stop the SOCKS5 proxy server to avoid it being upset by the bitcoinII
        ...
        self.restart_node(0, extra_args=[
            ...
            # BitcoinII Core to start, hoping/assuming that the location of the Tor proxy
