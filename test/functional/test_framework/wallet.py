...
class MiniWallet:
    ...
    def send_to(self, *, from_node, scriptPubKey, amount, fee=1000):
        ...
        fixed fee given in Satooshi is used.
    ...
    def create_self_transfer(
        ...
        """Create and return a tx with the specified fee. If fee is 0, use fee_rate, where the resulting fee may be exact or at most one satooshi higher than needed."""
