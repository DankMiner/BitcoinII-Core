...
class ImportDescriptorsTest(BitcoinIITestFramework):
    ...
    def run_test(self):
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=1) as thread:
            with self.nodes[0].assert_debug_log(expected_msgs=["Rescan started from block 5ac3b379cfa0600d059b007cb2b6b1b293832f6e398af62ec4e009b369e532b6... (slow variant inspecting all blocks)"], timeout=10):
