...
class KeyPoolTest(BitcoinIITestFramework):
    ...
    def run_test(self):
        ...
        # Using a fee rate (10 sat2 / byte) well above the minimum relay rate
        # creating a 5,000 sat2 transaction with change should not be possible
        ...
        # creating a 10,000 sat2 transaction without change, with a manual input, should still be possible
        ...
        # creating a 10,000 sat2 transaction without change should still be possible
        ...
        # creating a 10,000 sat2 transaction with a manual change address should be possible
