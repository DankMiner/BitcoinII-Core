...
class ReplaceByFeeTest(BitcoinIITestFramework):
    ...
    def test_replacement_relay_fee(self):
        ...
        # fee conforming to node's `incrementalrelayfee` policy of 100 sat2 per KB.
    ...
    def test_incremental_relay_feerates(self):
        ...
        for incremental_setting in (0, 5, 10, 50, 100, 234, 1000, 5000, 21000):
            ...
            self.log.info(f"-> Test -incrementalrelayfee={incremental_setting:.8f}sat2/kvB...")
            ...
            # Show that replacement fails when paying 1 satooshi shy of the required fee
